...
function useLocationData(postId, showVenue, refreshTrigger) {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useEffect)(() => {
    if (refreshTrigger > 0 && postId) {
      ...
      invalidateResolution('getEntityRecord', ['postType', 'gatherpress_event', postId]);
    }
 ...
 */
function useLocationHierarchy(postId, locationTerms, venueName, venueLink, startLevel, endLevel, minLevel, maxLevel, enableLinks, showVenue, separator, isInQueryLoop) {
  const [hierarchy, setHierarchy] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useState)('');
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useEffect)(() => {
    ...
    const paths = buildHierarchyPaths(locationTerms, startLevel, endLevel, minLevel, enableLinks, separator);
    if (paths.length === 0) {
      if (showVenue && venueName) {
    ...
    setIsLoading(false);
  }, [postId, locationTerms, venueName, venueLink, startLevel, endLevel, minLevel, maxLevel, enableLinks, showVenue, separator, isInQueryLoop]);
  return {
...
function buildTermPath(term, allTerms, enableLinks) {
  ...
  while (currentTerm && depth < maxDepth) {
    ...
    const termText = enableLinks && currentTerm.link ? `<a href="${currentTerm.link}" class="gatherpress-location-link" onclick="event.preventDefault();">${currentTerm.name}</a>` : currentTerm.name;
...
function DualRangeControl({
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)("div", {
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("div", {
      ...
      children: visibleLabels.map((levelLabel, index) => {
      ...
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)("div", {
        ...
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("div", {
          ...
          className: `dual-range-control__handle dual-range-control__handle--start ${isDraggingStart ? 'is-dragging' : ''}`,
          style: {
            left: `${startPercent}%`
          },
...
function Edit({
  ...
  const isSavingPost = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_5__.useSelect)(select => select('core/editor').isSavingPost(), []);
  const [lastSaveState, setLastSaveState] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useState)(false);
  const [refreshTrigger, setRefreshTrigger] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useState)(0);
  ...
  } = useLocationData(postId, showVenue, refreshTrigger);

  // Build location hierarchy display
  const {
    locationHierarchy,
    isLoading: isHierarchyLoading
  } = useLocationHierarchy(postId, locationTerms, venueName, venueLink, startLevel, endLevel, minLevel, maxLevel, enableLinks, showVenue, separator, isInQueryLoop);
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.Fragment, {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(BlockInspectorControls, {
      attributes: attributes,
      setAttributes: setAttributes,
      minLevel: minLevel,
      maxLevel: maxLevel
...
const VenueTermChangeListener = () => {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_4__.useEffect)(() => {
    ...
    const currentVenue = Array.isArray(venueTaxonomyIds) && venueTaxonomyIds.length ? venueTaxonomyIds[0] : null;
